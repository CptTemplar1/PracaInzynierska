...
import 'user_videos_page_model.dart';
export 'user_videos_page_model.dart';

class UserVideosPageWidget extends StatefulWidget {
  const UserVideosPageWidget({
    Key? key,
    this.selectedUser,
  ...
  @override
  _UserVideosPageWidgetState createState() => _UserVideosPageWidgetState();
}

class _UserVideosPageWidgetState extends State<UserVideosPageWidget> {
  late UserVideosPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserVideosPageModel());
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: AutoSizeText(
              'Filmiki użytkownika ${widget.selectedUserKKTubeAccount?.nick}',
              maxLines: 2,
                            ...
                            return Visibility(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      'UserSelectedVideoPage',
                                      queryParameters: {
                                        'userSelectedVideo': serializeParam(
