...
class DeleteAccountPageWidget extends StatefulWidget {
  const DeleteAccountPageWidget({Key? key}) : super(key: key);
                        ...
                        children: [
                          Expanded(
                            child: InkWell(
                              ...
                              onTap: () async {
                                FFAppState().secretCounter3 =
                                    FFAppState().secretCounter3 + 1;
                              },
                              child: Image.asset(
                                'assets/images/Screen_Shot_2017-09-18_at_3.07.05_PM.jpg',
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'PRZEPISZ TEN CIĄG W POLE PONIŻEJ',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: 'Poppins',
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return WebViewAware(
                                        ...
                                        title: Text('BŁĄD'),
                                        content: Text(
                                            'Podane wartości są niepoprawne. Spróbuj ponownie.'),
                                        actions: [
                                          TextButton(
