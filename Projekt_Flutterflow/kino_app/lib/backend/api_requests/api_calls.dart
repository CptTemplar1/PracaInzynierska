...
class GetPromoCodeCall {
  static Future<ApiCallResponse> call({
    String? id = '',
  }) async {
    return ApiManager.instance.makeApiCall(
      callName: 'GetPromoCode',
      apiUrl:
  ...
  static String? value(dynamic response) => castToType<String>(getJsonField(
        response,
        r'''$.fields.value.integerValue''',
      ));
  static bool? wasUsed(dynamic response) => castToType<bool>(getJsonField(
        response,
        r'''$.fields.wasUsed.booleanValue''',
      ));
  static String? code(dynamic response) => castToType<String>(getJsonField(
        response,
        r'''$.fields.code.stringValue''',
      ));
}
